  ...
  <section class="rateup70">
    <div v-if="showRateup1">
      <div class="images-container">
        <img src="https://vishuro.b-cdn.net/TheGoddess'sScorn.png" alt="RateUp 1" class="rateup-image">
        <img src="/plume.png" alt="RateUp 2" class="rateup-image">
    ...
    <div v-if="showRateup2">
      <div class="images-container">
        <img src="/scir.png" alt="RateUp 4" class="rateup-image">
        <img src="/startrail.png" alt="RateUp 5" class="rateup-image">
        <img src="/alpha.png" alt="RateUp 6" class="rateup-image">
      </div>
      <div class="timer">
...
export default {
  data() {
    return {
      startTime1: new Date('2025-03-01T15:01:00').getTime(),
      endTime1: new Date('2025-03-13T15:54:59').getTime(),
      startTime2: new Date('2025-03-13T15:55:00').getTime(),
      endTime2: new Date('2025-03-15T19:25:00').getTime(),
      timerInterval1: null,
      timerInterval2: null,
      timeLeft1: '',
      timeLeft2: '',
